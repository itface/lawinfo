...
import com.lawinfo.log.util.IPAddress;
import com.lawinfo.log.util.IPRange;
import com.lawinfo.log.util.Utils;
...
public abstract class ResourceServlet extends HttpServlet {
    ...
    protected final static Logger LOG = LoggerFactory.getLogger(ResourceServlet.class);

    public static final String SESSION_USER_KEY = "loginfo-user";
    ...
    protected abstract void initLogEnv();
    ...
    protected void returnResourceFile(String fileName, String uri, HttpServletResponse response)
        ...
        if (fileName.endsWith(".jpg") || fileName.endsWith(".ttf")  || fileName.endsWith(".woff")) {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (isRequireAuth() //
            ...
            if (contextPath.equals("") || contextPath.equals("/")) {
                response.sendRedirect("/loginfo/login.html");
            } else {
                if ("".equals(path)) {
                    response.sendRedirect("loginfo/login.html");
                } else {
        ...
        if ("".equals(path)) {
            if (contextPath.equals("") || contextPath.equals("/")) {
                response.sendRedirect("/loginfo/index.html");
            } else {
                response.sendRedirect("loginfo/index.html");
            }
            return;
        ...
        if (path.contains(".json")) {
            response.getWriter().print(process(path, request));
            return;
        }
    ...
    protected abstract String process(String path, HttpServletRequest request);
}
